...
### note記事シリーズ「AIで素人がWebサービス作る話」

**概要**
開発過程をnoteで連載中。シーズン1（①〜⑥）はAIの使い方・考え方、番外編①②③は開発TIPSと用語集、シーズン2（⑦〜）は実装の具体的な話。

**noteアカウント**
- プロフィール：https://note.com/peacewanwan
- RSSフィード：https://note.com/peacewanwan/rss

**記事URL一覧**

| # | タイトル | URL |
|---|---|---|
| マガジン(S1) | AIで素人がWebサービス作る話 season1 | https://note.com/peacewanwan/m/m9b21729eab5e |
| ① | 車のオフ会が見つかるサイト作ってる | https://note.com/peacewanwan/n/n51fa25975bf4 |
| ② | どうやってサイト作ってるのか | https://note.com/peacewanwan/n/nfbbd2c9c7c8b |
| ③ | どんなAI使ってサイト作ってるのか | https://note.com/peacewanwan/n/na1c2a94f4498 |
| ④ | ChatGPTで何を相談してたのか | https://note.com/peacewanwan/n/n3c03354200af |
| ⑤ | Geminiでどうやって別視点を入れてるのか | https://note.com/peacewanwan/n/n8dd03fa2149c |
| ⑥ | Claudeでどうやって実装まで落としてるのか | https://note.com/peacewanwan/n/n663e11c79b65 |
| 番外編① | とりあえずAIに聞きまくってた話 | https://note.com/peacewanwan/n/nea3c8bf57bf5 |
| 番外編② | 同じところで何回もハマってた話 | https://note.com/peacewanwan/n/n28a1d899d225 |
| 番外編③ | 言葉の意味も分からず開発を進めてた話 | 投稿待ち |
| ⑦〜⑪ | シーズン2（実装編） | 下書き保存済み（URL未取得） |
| ⑫ | Claude Codeで開発が変わった話 | 草案完成（投稿待ち） |

**進捗**
- ①〜⑥＋番外編①②：公開済み（リライト完了）
- 番外編③（用語集）：完成版あり（note_bangaihen03_glossary.md）・投稿待ち
- ⑦〜⑪：リライト完了・下書き保存済み
- ⑫：草案完成・投稿待ち
- ⑬以降：未着手（チャット履歴zipから記事化するワークフローが確立済み）

**文体・スタイルルール**
- ですます調NG・体験談として書く（一人称「自分」NG）
- 箇条書き多用NG・文章で繋げる
- 体言止めNG・文末は動詞か「〜だった」「〜している」で着地
- 絵文字NG・バッククォートNG（noteで反映されない）
- 見出し：##大見出し・###小見出し
- 区切り：---
- リンク：URLそのまま記載（Markdownリンク記法はnote非対応）
- フッター：各行の間に空行。公開済み記事は加筆修正日付あり
- 出力：PC作業時はMDファイル（iPhoneではリッチテキスト化で崩れる）
- 専門用語：読者向けにかみ砕いた説明を入れる
...
**noteへのリンク挿入方法**
- MD内で「第6回（ URL ）」形式でURLを添付
- noteエディタでURLをカット→文字選択→リンクボタン→ペーストで設定
- URLそのまま記載すればnoteが自動リンク化（フッター等）

**noteの記事URL取得方法**
- プロフィールページからの静的スクレイピングは不可（JSで動的リンク）
- RSSのXML（/rss）をコピペしてClaudeに渡すのが最も確実
- 新記事公開時にRSS貼ってもらえば全記事URLを一発取得可能
...
|2026-04-07|note記事①〜⑪＋番外編①②リライト完了・note文体ルール確定                                           |
|2026-04-07|note記事⑫（Claude Code導入）草案完成                                                   |
|2026-04-07|チャット履歴zipから記事化するワークフロー確立                                                    |
|2026-04-08|番外編③「用語集」完成（37語・ツール→関連用語の構造・【】囲み＋読み仮名）                                     |
|2026-04-08|番外編タイトルフォーマット確定：【番外編◯】〜〜〜（本編とは別形式）                                          |
|2026-04-08|noteへのリンク挿入方法確立：「第6回（ URL ）」形式→エディタでカット＆リンク貼り                               |
|2026-04-08|note記事URL取得方法確立：RSSのXMLコピペが最も確実                                              |
...
- note記事①〜⑪＋番外編①②リライト完了・公開済み
- note記事⑫（Claude Code導入）草案完成
- 番外編③「用語集」完成版作成（note_bangaihen03_glossary.md）
...
- [ ] スポットデータ拡充（九州・北海道）
- [ ] フェンダリストM をsourcesに追加（check_sources.py確認後）
...
- [ ] note⑬以降の新規執筆（チャット履歴zipから記事化）
- [ ] note⑦〜⑫公開後に番外編③内の第◯回リンクを追加
- [ ] マガジンRSS（/m/.../rss）の存在確認
